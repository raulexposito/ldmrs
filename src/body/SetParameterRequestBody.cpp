#include "hdr/SetParameterRequestBody.h"
...
SetParameterRequestBody::SetParameterRequestBody(ParameterEnum parameter, uint32_t value):
...
void SetParameterRequestBody::addParameterCode(ParameterEnum parameter) {
...
void SetParameterRequestBody::addUINT32ParameterValue(uint32_t value) {
...
void SetParameterRequestBody::addUINT16ParameterValue(uint32_t value) {
